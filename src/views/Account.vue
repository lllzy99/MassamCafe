<template>
  <div class="account">
    ...
    <BgBlock>
      ...
      <van-cell title="用户id" :center="true" :border="false">{{accountInfo.userId}}</van-cell>
      <van-cell title="手机号" :center="true" :border="false">{{accountInfo.phone}}</van-cell>
      <van-cell title="昵称" :center="true" :border="false">
        <van-field
